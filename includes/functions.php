...
/* <span class="%1$s">Posted on </span><span class="%3$s"> by </span>%4$s*/
	'meta-prep meta-prep-author posted', 
	sprintf( '<span>- </span><a href="%1$s" title="%2$s" rel="bookmark"><span class="timestamp updated">%3$s</span></a><span> -</span>',
...
function responsive_breadcrumb_lists() {
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
            'name' => __('Home Featured Text', 'responsive'),
            'description' => __('Area A - sidebar-home-featured-text.php', 'responsive'),
            'id' => 'home-featured-text',
            'before_title' => '<div id="widget-title-one" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
            'after_widget' => '</div>'
        ...
        register_sidebar(array(
            'name' => __('Home Featured Content', 'responsive'),
            'description' => __('Area B - sidebar-home-featured-content.php', 'responsive'),
            ...
            'description' => __('Area C - sidebar-footer-left.php', 'responsive'),
            'id' => 'footer-left',
            'before_title' => '<div id="widget-title-one" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
        ...
        register_sidebar(array(
            ...
            'description' => __('Area D - sidebar-footer-center.php', 'responsive'),
            'id' => 'footer-center',
            'before_title' => '<div id="widget-title-one" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
		...
		register_sidebar(array(
            ...
            'description' => __('Area E - sidebar-footer-right.php', 'responsive'),
            'id' => 'footer-right',
            'before_title' => '<div id="widget-title-one" class="widget-title-home"><h3>',
            'after_title' => '</h3></div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
...
// Remove Automatically inserted p tag
...
// Remove contents of wp_head()
remove_action('wp_head','wp_generator');//remove wordpress version
remove_action('pre_post_update', 'wp_save_post_revision' );//remove Revision
...
if (!is_admin()) {
   function register_script(){
	   ...
	   wp_register_script('prettify', get_bloginfo('template_directory').'/js/prettify.js');
   }
   function add_script() {
     register_script();
	 ...
	 if (is_single() or is_page()){
		 wp_enqueue_script( 'prettify', array( 'jquery' ), '1.0');
	 }
   }
